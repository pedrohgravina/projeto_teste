# Análise estatística de uma base de dados de diabetes
...
|
├── imagens         <- Imagens utilizadas do projeto.
```
...
1. Faça o clone do repositório.
    ...
    ```bash
    git clone git@github.com:pedrohgravina/projeto_teste.git
    ```
